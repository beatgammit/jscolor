 ...
 *
 * Copyright (c) 2013 T. Jameson Little <t.jameson.little@gmail.com>
 *
 ...
 *
 * This is a fork of jscolor, and incorporates work covered by the following
 * notice (notice unmodified from time of fork, information may be out of date):
 */
...
(function () {
	...
	function Color(target, prop) {
		...
		this.showPicker = function () {
			...
			if (!isPickerOwner()) {
				tp = jscolor.getElementPos(target); // target pos
